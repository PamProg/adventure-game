...
import { RESULT_FIGHT, RESULT_FLY, RESULT_WATCH, RESULT_HIDE } from "./list-result";
...
export const CHOICE_HELLO_WORLD: Choice[] = [
    CHOICE_HELLO_WORLD_FIRST,
    CHOICE_HELLO_WORLD_SECOND,
    CHOICE_HELLO_WORLD_THIRD,
    CHOICE_HELLO_WORLD_FOURTH,
    CHOICE_HELLO_WORLD_FIFTH
];
